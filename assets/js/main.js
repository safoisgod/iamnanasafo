...
(function ($) {
    ...
    function skill_excel() {
        $('#excel').LineProgressbar({
            percentage: 90,
            radius: '3px',
            height: '10px',
            duration: 6000,
    ...
    function skill_powerbi() {
        $('#powerbi').LineProgressbar({
            percentage: 85,
            radius: '3px',
            height: '10px',
            duration: 6000,
    ...
    function skill_backend() {
        $('#backend').LineProgressbar({
            percentage: 60,
            radius: '3px',
            height: '10px',
            duration: 6000,
